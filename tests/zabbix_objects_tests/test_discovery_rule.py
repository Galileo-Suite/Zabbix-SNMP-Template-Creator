...
def test_discovery_rule_initialization(
...
def test_generate_discovery_rules(sample_discovery_rule_table, sample_template_name):
    ...
    with patch(
        "src.zabbix_objects.discovery_rule.DiscoveryRule"
    ) as mock_discovery_rule:
        DiscoveryRule.generate_discovery_rules(
            discovery_rule_table, sample_template_name
        )
        mock_discovery_rule.assert_called_once_with(
            sample_discovery_rule_table, sample_template_name
        )
