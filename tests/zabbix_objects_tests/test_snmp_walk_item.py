...
def test_snmp_walk_item_initialization(sample_discovery_rule_table, sample_template_name):
...
def test_parse_oids(sample_discovery_rule_table, sample_template_name):
    ...
    assert snmp_walk_item._parse_oids(sample_discovery_rule_table) == expected_oid_string
